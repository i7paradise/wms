...
public class DoorAntennaDTO implements Serializable {
    ...
    private UHFRFIDAntennaDTO uhfRFIDAntenna;
    ...
    public UHFRFIDAntennaDTO getUhfRFIDAntenna() {
        return uhfRFIDAntenna;
    }

    public void setUhfRFIDAntenna(UHFRFIDAntennaDTO uhfRFIDAntenna) {
    ...
    public String toString() {
        return "DoorAntennaDTO{" +
            ...
            ", type='" + getType() + "'" +
            ", door=" + getDoor() +
            ", uhfRFIDAntenna=" + getUhfRFIDAntenna() +
            "}";
    }
}
