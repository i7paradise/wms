...
describe('CompanyContainer Management Component', () => {
  let comp: CompanyContainerComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CompanyContainerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.companyContainers[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
