...
describe('CompanyProduct Management Component', () => {
  let comp: CompanyProductComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CompanyProductComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.companyProducts[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
