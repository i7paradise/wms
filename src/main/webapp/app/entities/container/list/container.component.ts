...
export class ContainerComponent implements OnInit {
  ...
  constructor(protected containerService: ContainerService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.containers = [];
  ...
  loadAll(): void {
    ...
    this.containerService
      ...
      .subscribe({
        next: (res: HttpResponse<IContainer[]>) => {
          this.isLoading = false;
          this.paginateContainers(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateContainers(data: IContainer[] | null, headers: HttpHeaders): void {
