...
describe('DeliveryContainer Management Component', () => {
  let comp: DeliveryContainerComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DeliveryContainerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.deliveryContainers[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
