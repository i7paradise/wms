...
export class DoorAntennaUpdateComponent implements OnInit {
  ...
  protected updateForm(doorAntenna: IDoorAntenna): void {
    this.editForm.patchValue({
      ...
      uhfRFIDAntenna: doorAntenna.uhfRFIDAntenna,
    });
    ...
    this.uHFRFIDAntennaService
      ...
      .pipe(
        map((uHFRFIDAntennas: IUHFRFIDAntenna[]) =>
          this.uHFRFIDAntennaService.addUHFRFIDAntennaToCollectionIfMissing(uHFRFIDAntennas, this.editForm.get('uhfRFIDAntenna')!.value)
        )
      )
  ...
  protected createFromForm(): IDoorAntenna {
    return {
      ...
      uhfRFIDAntenna: this.editForm.get(['uhfRFIDAntenna'])!.value,
    };
  }
}
