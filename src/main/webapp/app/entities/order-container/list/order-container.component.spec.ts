...
describe('OrderContainer Management Component', () => {
  let comp: OrderContainerComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OrderContainerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.orderContainers[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
