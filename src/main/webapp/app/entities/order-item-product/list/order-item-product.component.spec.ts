...
describe('OrderItemProduct Management Component', () => {
  let comp: OrderItemProductComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OrderItemProductComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.orderItemProducts[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
