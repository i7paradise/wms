...
export class OrderItemComponent implements OnInit {
  ...
  constructor(protected orderItemService: OrderItemService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.orderItems = [];
    ...
    this.orderItemService
      ...
      .subscribe({
        next: (res: HttpResponse<IOrderItem[]>) => {
          ...
          this.paginateOrderItems(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
