...
export class WarehouseComponent implements OnInit {
  ...
  constructor(protected warehouseService: WarehouseService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.warehouses = [];
    ...
    this.warehouseService
      ...
      .subscribe({
        next: (res: HttpResponse<IWarehouse[]>) => {
          ...
          this.paginateWarehouses(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateWarehouses(data: IWarehouse[] | null, headers: HttpHeaders): void {
