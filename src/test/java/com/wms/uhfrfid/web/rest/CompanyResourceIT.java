...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).address(DEFAULT_ADDRESS).phone(DEFAULT_PHONE).description(DEFAULT_DESCRIPTION);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE).description(UPDATED_DESCRIPTION);
        return company;
    }
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE).description(UPDATED_DESCRIPTION);
