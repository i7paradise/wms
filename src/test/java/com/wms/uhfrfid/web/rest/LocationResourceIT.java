...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().name(DEFAULT_NAME).note(DEFAULT_NOTE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().name(UPDATED_NAME).note(UPDATED_NOTE);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getNote()).isEqualTo(DEFAULT_NOTE);
    }
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.name(UPDATED_NAME).note(UPDATED_NOTE);
        ...
        assertThat(testLocation.getNote()).isEqualTo(UPDATED_NOTE);
    }
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).note(UPDATED_NOTE);
